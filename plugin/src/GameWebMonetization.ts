...
export class GameWebMonetization extends EventEmitter
{
     ...
     * 
     * Using this event you can determine if you should display some extra benefits,
     * or a Thank you message, to the player.
     * 
     * @event
    ...
    /**
     * The event is emitted while the Web Monetization API is preparing to start
    ...
    /**
     * This event is emitted when the Web Monetization API is stopped.
     * 
     * @event
     * @property {string} paymentPointer - Your payment account URL. The same value is used as the content in your <meta> tag.
     * @property {string} requestId - This value is identical to the session ID/monetization ID (UUID v4) generated by the user agent (see Flow).
    ...
    /**
     * Is the Web Monetization API active, or not?
     * 
     * @readonly
     */
    ...
    /**
     * The current state of the Web Monetization API.
     * 
     ...
     * 
     * You should pass in a {@link PaymentConfig} object to the class. This object
     * contains your Payment Pointer address, along with an optional friendly-name
     * for it. Such as:
     * 
     * @example
     * ```
     ...
     * ```
     * 
     * If you want to divide your earnings between multiple Payment Pointers, you can use
     * Probalistic Revenue Sharing. This is handled by providing an array of {@link PaymentConfig}
     * objects, where each object has a `weight` property set. This is a value between
     * 0 and 100.
     * 
     * The weight is used to calculate which Payment Provider will be used and injected into
     * the `meta` tag of the page. For more information, please see the official
     * documentation on [Probalistic Revenue Sharing](https://webmonetization.org/docs/probabilistic-rev-sharing).
     * 
     * @example
     * ```
     * new GameWebMonetization([
     ...
     * ]);
     * ```
     * @param config The Payment Configuration object, or an array of them for Probalistic Revenue Sharing.
     */
    ...
    /**
     * Stops the Web Monetization process, removing the event listners and
     * `meta` tags from the document head.
     * 
     * @returns The GameWebMonetization instance.
     */
    stop (): this
     ...
     * 
     * Sets the default start and emits the {@link GameWebMonetization.START} event.
     *
     ...
     * 
     * Emits the {@link GameWebMonetization.PENDING} event.
     *
     ...
     * 
     * Updates the running `total` of streamed money and emits the {@link GameWebMonetization.PROGRESS} event.
     *
     * @param event The progress event.
     * @fires GameWebMonetization.PROGRESS
     */
     ...
     * 
     * Stops the state and emits the {@link GameWebMonetization.STOP} event.
     *
